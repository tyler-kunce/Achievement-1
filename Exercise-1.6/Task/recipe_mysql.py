...
def update_recipe(conn, cursor):
    ...
    recipe_id = int(input("Enter the ID of the recipe you wish to update: "))
    ...
    if column_update in ['ingredients', 'cooking_time']:
        ...
        difficulty = calculate_difficulty(recipe[0], recipe[1])
        update_sql = 'UPDATE Recipes SET difficulty = %s WHERE id = %s'
        cursor.execute(update_sql, (difficulty, recipe_id))
